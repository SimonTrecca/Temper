 ...
 * @return Tensor<float_t> Tensor of shape `out_shape` with samples ~ N(0,1).
 */
 ...
 * @return Tensor<float_t> Quantiles with the broadcasted shape.
 *
 ...
 * @return Tensor<float_t> Samples with shape out_shape.
 *
